            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    <li class="nav-item mx-1">
                        <a class="nav-link btn btn-light active" href="index.html">Αρχική</a>
                    </li>
                    <li class="nav-item mx-1">
                        <a class="nav-link btn btn-light" href="views/tasks.html">Λίστα εργασιών</a>
                    </li>
                    <li class="nav-item mx-1">
                        <a class="nav-link btn btn-light" href="views/groups.html">Ομάδες</a>
                    </li>
                </ul>

                <a class="btn ms-auto" href="views/login.html" title="Είσοδος">
